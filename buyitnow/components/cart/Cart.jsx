                      ...
                      <div className="flex flex-wrap lg:flex-row gap-5  mb-4">
                        <div className="w-full lg:w-2/5 xl:w-2/4">
                          <figure className="flex leading-5">
                            <div>
                              <div className="block w-16 h-16 rounded border border-gray-200 overflow-hidden object-cover">
                                <Image src={cartItem?.image? cartItem.image.url : ""} alt={cartItem.name} width={64} height={64}/>
                              </div>
                            </div>
                        ...
                        <div>
                          <div className="leading-5">
                            <p className="font-semibold not-italic">
                              ${(parseFloat(cartItem.price.toFixed(2)) * cartItem.quantity.toFixed(2)).toFixed(2)}
                            </p>
                        ...
                        <div className="flex-auto">
                          <div className="float-right">
                            <a
                              ...
                              onClick={() =>
                                deleteCartItems(cartItem?.product)
                              }
                            >
                              Remove
                            </a>
